...
namespace API_MortalKombat.Migrations
{
    ...
    [Migration("20240110054427_AgregandoClaseEstiloDePelea")]
    partial class AgregandoClaseEstiloDePelea
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EstiloDePeleaPersonaje", b =>
                {
                    b.Property<int>("EstilosDePeleaId")
                        .HasColumnType("int");

                    b.Property<int>("PersonajesId")
                        .HasColumnType("int");

                    b.HasKey("EstilosDePeleaId", "PersonajesId");
            ...
            modelBuilder.Entity("MortalKombat_API.Models.Arma", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 1, 10, 2, 44, 27, 177, DateTimeKind.Local).AddTicks(7950),
                            Nombre = "Kori Blade"
                        },
                        new
                        {
                            ...
                            FechaActualizacion = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FechaCreacion = new DateTime(2024, 1, 10, 2, 44, 27, 177, DateTimeKind.Local).AddTicks(7961),
                            Nombre = "Kunai"
                        });
                });
            ...
            modelBuilder.Entity("MortalKombat_API.Models.Clan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaActualizacion = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FechaCreacion = new DateTime(2024, 1, 10, 2, 44, 27, 177, DateTimeKind.Local).AddTicks(7863),
                            Nombre = "Lin Kuei"
                        },
                        new
                        {
                            ...
                            FechaActualizacion = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FechaCreacion = new DateTime(2024, 1, 10, 2, 44, 27, 177, DateTimeKind.Local).AddTicks(7899),
                            Nombre = "Shirai Ryu"
                        });
                });
            ...
            modelBuilder.Entity("MortalKombat_API.Models.Personaje", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaActualizacion = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FechaCreacion = new DateTime(2024, 1, 10, 2, 44, 27, 177, DateTimeKind.Local).AddTicks(7935),
                            ImagenURl = "",
                            Nombre = "Sub-Zero",
            ...
            modelBuilder.Entity("MortalKombat_API.Models.Reino", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaActualizacion = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FechaCreacion = new DateTime(2024, 1, 10, 2, 44, 27, 177, DateTimeKind.Local).AddTicks(7915),
                            Nombre = "Tierra"
                        });
                });
            ...
            modelBuilder.Entity("EstiloDePeleaPersonaje", b =>
                {
                    b.HasOne("API_MortalKombat.Models.EstiloDePelea", null)
                        .WithMany()
                        .HasForeignKey("EstilosDePeleaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
