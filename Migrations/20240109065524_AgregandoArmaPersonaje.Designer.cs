...
namespace API_MortalKombat.Migrations
{
    ...
    [Migration("20240109065524_AgregandoArmaPersonaje")]
    partial class AgregandoArmaPersonaje
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MortalKombat_API.Models.Clan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 1, 9, 3, 55, 24, 559, DateTimeKind.Local).AddTicks(6407),
                            Nombre = "Lin Kuei"
                        },
                        new
                        {
                            ...
                            FechaActualizacion = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FechaCreacion = new DateTime(2024, 1, 9, 3, 55, 24, 559, DateTimeKind.Local).AddTicks(6442),
                            Nombre = "Shirai Ryu"
                        });
                });
            ...
            modelBuilder.Entity("MortalKombat_API.Models.Personaje", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaActualizacion = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FechaCreacion = new DateTime(2024, 1, 9, 3, 55, 24, 559, DateTimeKind.Local).AddTicks(6481),
                            ImagenURl = "",
                            Nombre = "Sub-Zero",
            ...
            modelBuilder.Entity("MortalKombat_API.Models.Reino", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaActualizacion = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FechaCreacion = new DateTime(2024, 1, 9, 3, 55, 24, 559, DateTimeKind.Local).AddTicks(6458),
                            Nombre = "Tierra"
                        });
                });
