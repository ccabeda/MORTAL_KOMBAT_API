...
namespace API_MortalKombat.Migrations
{
    ...
    [Migration("20240103065054_AgregandoNuevoClan")]
    partial class AgregandoNuevoClan
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MortalKombat_API.Models.Clan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 1, 3, 3, 50, 54, 43, DateTimeKind.Local).AddTicks(1128),
                            Nombre = "Lin Kuei"
                        },
                        new
                        {
                            ...
                            FechaActualizacion = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FechaCreacion = new DateTime(2024, 1, 3, 3, 50, 54, 43, DateTimeKind.Local).AddTicks(1167),
                            Nombre = "Shirai Ryu"
                        });
                });
            ...
            modelBuilder.Entity("MortalKombat_API.Models.Personaje", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaActualizacion = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FechaCreacion = new DateTime(2024, 1, 3, 3, 50, 54, 43, DateTimeKind.Local).AddTicks(1234),
                            ImagenURl = "",
                            Nombre = "Sub-Zero",
            ...
            modelBuilder.Entity("MortalKombat_API.Models.Reino", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaActualizacion = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FechaCreacion = new DateTime(2024, 1, 3, 3, 50, 54, 43, DateTimeKind.Local).AddTicks(1184),
                            Nombre = "Tierra"
                        });
                });
