...
namespace API_MortalKombat.Migrations
{
    ...
    [Migration("20240110054528_AgregandoClaseEstiloDePeleaV2")]
    partial class AgregandoClaseEstiloDePeleaV2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MortalKombat_API.Models.Arma", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2024, 1, 10, 2, 45, 28, 104, DateTimeKind.Local).AddTicks(5922),
                            Nombre = "Kori Blade"
                        },
                        new
                        {
                            ...
                            FechaActualizacion = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FechaCreacion = new DateTime(2024, 1, 10, 2, 45, 28, 104, DateTimeKind.Local).AddTicks(5935),
                            Nombre = "Kunai"
                        });
                });
            ...
            modelBuilder.Entity("MortalKombat_API.Models.Clan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaActualizacion = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FechaCreacion = new DateTime(2024, 1, 10, 2, 45, 28, 104, DateTimeKind.Local).AddTicks(5799),
                            Nombre = "Lin Kuei"
                        },
                        new
                        {
                            ...
                            FechaActualizacion = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FechaCreacion = new DateTime(2024, 1, 10, 2, 45, 28, 104, DateTimeKind.Local).AddTicks(5867),
                            Nombre = "Shirai Ryu"
                        });
                });
            ...
            modelBuilder.Entity("MortalKombat_API.Models.Personaje", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaActualizacion = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FechaCreacion = new DateTime(2024, 1, 10, 2, 45, 28, 104, DateTimeKind.Local).AddTicks(5909),
                            ImagenURl = "",
                            Nombre = "Sub-Zero",
            ...
            modelBuilder.Entity("MortalKombat_API.Models.Reino", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaActualizacion = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FechaCreacion = new DateTime(2024, 1, 10, 2, 45, 28, 104, DateTimeKind.Local).AddTicks(5890),
                            Nombre = "Tierra"
                        });
                });
